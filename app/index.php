...
<div class="bg-image">
  <div class="section-1">
    <h1>
      Купи Power Bank!<br>
      <small>Добавь своему гаджету енергии</small>
    </h1>
    <div class="bounce">
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">189.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-1" class="model">
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-2" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-3" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-4" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-5" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-6" class="model">
              <input  data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-7" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-3">
        <div class="absolute">
          <div class="product">
            ...
            <div class="price">198.99 <span>грн.</span></div>
            <form class="ajaxform" method="POST">
              <input type="hidden" name="model" value="model-8" class="model">
              <input data-toggle="modal" data-target="#myModal" type="submit" value="Заказать" name="order" class="submit">
            </form>
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <input type="text">
          <input id="hidden-jquery" type="submit" value="Позвонить мне">
        </form>
      </div>
